...
<html>
  ...
  <body>
    <form action="">
		...
		证件编号:<input type="text" readonly="readonly" name="certNumber" value="${checkin.certNumber }"/><br>
		地址信息:<input type="text" readonly="readonly" name="address" value="${checkin.address }"/><br>
		备注:<input type="text" readonly="readonly" name="comment" value="${checkin.comment }"/><br>
		...
		续住天数:<input type="text" name="reNumOfDays"><br>
		续交押金:<input type="text" name="reDeposit"/>
		<input type="submit" value="办理续住"/>
    </form>
  </body>
</html>
