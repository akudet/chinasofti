...
public class ReservationServlet extends CRUDServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int flag= rs.add(reservationId, name, phone, roomTypeDesc, arriveTime, reserveTime, reservationTime, comment);
		if (flag > 0) {
	...
	protected void doPut(HttpServletRequest req, HttpServletResponse resp)
		...
		int flag= rs.updateById(reservationId, name, phone, arriveTime, reserveTime, reservationTime, comment);
		if (flag > 0) {
