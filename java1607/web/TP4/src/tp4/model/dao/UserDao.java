...
public class UserDao {
	...
	public ArrayList<User> findAll() {
		...
		try {
			...
			while (res.next()) {
				User user = new User(res.getString("userid"),res.getString("username"),
						res.getString("userpass"),res.getInt("privilege"));
...
//单查询
		public User findById(String userId){
			...
			try {
				...
				res = pre.executeQuery();
				if(res.next()){
					User user = new User(res.getString("userid"),res.getString("userpass")
							,res.getString("userpass"),res.getInt("privilege"));
					return user;
				}
			} catch (SQLException e) {
