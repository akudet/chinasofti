...
public class ReservationService {
	...
	public int add(String reservationId,String name, String phone, String roomTypeDesc,
		String arriveTime, String reserveTime,String reservationTime, String comment) 
	{
		Reservation Re=new Reservation(reservationId,name,phone,arriveTime,reserveTime,reservationTime,comment);
